  ...
  $.AdminLTE.boxWidget = {
    ...
    collapse: function (element) {
      ...
      if (!box.hasClass("collapsed-box")) {
        ...
        element.children(".fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");
        bf.slideUp(300, function () {
          box.addClass("collapsed-box");
        });
      } else {
        //Convert plus into minus
        element.children(".fa-caret-down").removeClass("fa-caret-down").addClass("fa-caret-up");
